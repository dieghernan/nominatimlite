...
- For bugs, [file an
  issue](https://github.com/dieghernan/nominatimlite/issues/new).
...
requests](https://github.com/dieghernan/nominatimlite/issues) to make
sure the bug has not already been reported or fixed in the development
