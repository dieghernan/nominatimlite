...
#> $ place_id                 <int> 270938992, 270518370, 270013325, 272551053, 7…
...
#> $ importance               <dbl> 0.43955427, 0.37221179, 0.32357442, 0.2101211…
...
#> $ address.neighbourhood    <chr> "Barrio de los Austrias", NA, NA, NA, NA, "Lo…
...
#> $ `address.ISO3166-2-lvl6` <chr> NA, "ES-SA", "ES-VA", "ES-CC", "ES-B", "ES-ZA…
#> $ address.suburb           <chr> NA, NA, "Plaza Mayor", NA, NA, "Barrio La Lan…
...
#> $ address.city_block       <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
