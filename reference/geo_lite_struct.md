...
#> $ place_id                 <int> 292554531, 292389199, 292113204, 293404755, 2…
...
#> $ address.state_district   <chr> NA, "Valladolid", "Segovia", "Cáceres", NA, "…
...
#> $ address.province         <chr> NA, NA, NA, NA, "Zamora", NA, "Palencia", NA,…
