...
- [**arcgeocoder**](https://dieghernan.github.io/arcgeocoder/)
  [@R-arcgeocoder]: Provides a lightweight interface for geocoding with the
...
here is from the geocoding query above. The single-line address is returned in
a column named with the `address` argument.
