...
description: Display Nominatim API results on interactive maps.
knitr:
  opts_chunk:
    collapse: true
    comment: "#>"
...
map](https://rstudio.github.io/leaflet/). It searches for cafes and restaurants
near the Eiffel Tower with `geo_amenity_sf()`.
