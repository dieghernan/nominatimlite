---
title: "Interactive maps with nominatimlite and leaflet"
description: Display Nominatim API results on interactive leaflet maps.
knitr:
  opts_chunk:
    collapse: true
    comment: "#>"
...
[**leaflet**](https://rstudio.github.io/leaflet/) map. It looks up cafes and
restaurants near the Eiffel Tower with `geo_amenity_sf()`.

The **crosstalk** and **reactable** packages link the map to a filterable table.
