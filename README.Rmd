...
You can easily convert the results of `nominatimlite` into `sf` objects, that
can be mapped with a variety of packages as `ggplot2`, `tmap` or `leaflet`.

The following example geocodes the restaurants and pubs surrounding Times
Square, New York. The area of search has been restricted to the geographic
bounding box of Times Square.
