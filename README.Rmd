...
```{r}
#| label: pizzahut
#| fig-alt: Locations of Pizza Hut restaurants in California extracted with nominatimlite
...
#| fig-alt: Location of Statue of Liberty extracted with nominatimlite
...
```{r}
#| label: line-object
#| fig-alt: Different features named Ohio extracted with nominatimlite
