...
This guide explains how to propose a change to **nominatimlite**. Review
...
Please note that the **nominatimlite** project is released with a
[Contributor Code of
Conduct](https://dieghernan.github.io/nominatimlite/dev/CODE_OF_CONDUCT.md).
