...
---
    ...
    Message
      ...
      No results found for query: lat = 90, long = 0.
...
# Fail
    ...
    Message
      Cannot reach the API endpoint: https://api.jsonserver.io/reverse?lat=40.75728&lon=-73.98&format=jsonv2&addressdetails=1.
